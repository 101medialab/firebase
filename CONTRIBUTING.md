...
$ go get -d -t github.com/101medialab/firebase-go-sdk-extended/... # Install dependencies
```
...
```bash
go test -test.short github.com/101medialab/firebase-go-sdk-extended/...
```
...
1. *Service account certificate*: This can be downloaded as a JSON file from
   ...
   `src/github.com/101medialab/firebase-go-sdk-extended/testdata/integration_cert.json`.
2. *Web API key*: This is displayed in the "Settings > General" tab of the
   ...
   `src/github.com/101medialab/firebase-go-sdk-extended/testdata/integration_apikey.txt`.

Now you can invoke the test suite as follows:

```bash
go test github.com/101medialab/firebase-go-sdk-extended/...
```
...
```bash
go test -cover github.com/101medialab/firebase-go-sdk-extended/auth
```
