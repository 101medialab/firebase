...
- [changed] Fixed a bug in the
  [`UnsubscribeFromTopic()`](https://godoc.org/github.com/101medialab/firebase-go-sdk-extended/messaging#Client.UnsubscribeFromTopic)
  function.
- [changed] Improved the error message returned by `GetUser()`,
  `GetUserByEmail()` and `GetUserByPhoneNumber()` APIs in
  [`auth`](https://godoc.org/github.com/101medialab/firebase-go-sdk-extended/auth) package.
...
- [added] A new [`VerifyIDTokenAndCheckRevoked()`](https://godoc.org/github.com/101medialab/firebase-go-sdk-extended/auth#Client.VerifyIDToken)
  function has been added to check for revoked ID tokens.
- [added] A new [`RevokeRefreshTokens()`](https://godoc.org/github.com/101medialab/firebase-go-sdk-extended/auth#Client.RevokeRefreshTokens)
...
- [added] A new property `TokensValidAfterMillis` has been added to the
  ['UserRecord'](https://godoc.org/github.com/101medialab/firebase-go-sdk-extended/auth#UserRecord)
...
- [changed] The `ProviderID` field on the
  [`auth.UserRecord`](https://godoc.org/github.com/101medialab/firebase-go-sdk-extended/auth#UserRecord)
...
- [added] A new user management API that supports querying and updating
  ...
  [`auth.Client`](https://godoc.org/github.com/101medialab/firebase-go-sdk-extended/auth#Client) API.
...
- [added] A new [Cloud Storage API](https://godoc.org/github.com/101medialab/firebase-go-sdk-extended/storage)
...
- [changed] When deployed in the Google App Engine environment, the SDK can
  ...
  call [`CustomToken()`](https://godoc.org/github.com/101medialab/firebase-go-sdk-extended/auth#Client.CustomToken)
  and [`CustomTokenWithClaims()`](https://godoc.org/github.com/101medialab/firebase-go-sdk-extended/auth#Client.CustomTokenWithClaims).
